...
import { PixelButton, PixelPanel, PixelTag, RetroBadge } from "@/components/ui/pixel-primitives"
    ...
    <footer className="relative border-t-[4px] border-[#09031a] bg-[#120822] text-[#f6ecff]">
      ...
      <div className="container relative z-10 space-y-10 py-12">
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-2">
              ...
              <RetroBadge tone="midnight" className="bg-[#291f4a] px-2 py-[2px] text-[9px] tracking-[0.3em] text-[#ffe17d]">
                Pixel Ops Studio
              </RetroBadge>
            </div>
          </div>
        ...
        <PixelPanel tone="ghost" padding="sm" className="space-y-4 text-[#1b1036] dark:text-[#f6ecff]">
          ...
          <RetroBadge tone="neutral" className="inline-flex px-3 py-[3px] text-[9px] tracking-[0.3em] text-[#1b1036]">
