        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-8 leading-tight">
              ...
              <span className="bg-neo-blue px-2 text-white border-2 border-black shadow-neo inline-block transform -rotate-1 mt-2">
                in a single box
              </span>
              .
            </h2>
            <p className="text-lg font-medium text-gray-700 mb-8 border-l-4 border-neo-yellow pl-4">
              We handle the complex infrastructure. You just push code. It’s
              like having a DevOps team in your pocket, but free.
            </p>
            ...
            <div className="grid gap-4">
              ...
              <div className="bg-white p-4 border-2 border-black shadow-neo-sm flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Deployed assets are served through a reliable CDN for quick
                    worldwide access.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 min-h-[300px] flex flex-col">
                ...
                {text.length === fullText.length && (
                  ...
                  >
                    ...
                    <div className="text-neo-yellow mt-2">
                      remote: Building project...
                    </div>
                    <div className="text-neo-yellow">
                      remote: Detected Vite app
                    </div>
                    <div className="text-neo-green mt-3 font-bold">
