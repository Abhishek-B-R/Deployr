...
export default async function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen min-w-full overflow-x-hidden px-16 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
